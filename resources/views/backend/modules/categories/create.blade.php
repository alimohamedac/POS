            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('backend.categories.store') }}" enctype="multipart/form-data" method="post" role="form">
                            @csrf
                            <div class="col-md-6 col-xs-12">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="name">{{ trans('backend/categories.attributes.name') }}</label>
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="name" placeholder="{{ trans('backend/categories.hints.name') }}" required>
                                    </div>
